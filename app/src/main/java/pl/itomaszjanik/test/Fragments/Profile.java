...
public class Profile extends Fragment implements NoteClickListener, GetPostsCallback, ReactNoteCallback,
    ...
    public void onLikeClick(View view, Note note){
        Utilities.onLikeNoteClick(getContext(), Profile.this, view, note);
    }
