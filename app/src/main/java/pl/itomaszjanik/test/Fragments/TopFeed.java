...
public class TopFeed extends Fragment {
    ...
    private List<Note> createPosts(){
        ...
        list.add(new Note("Dlaczego w każdym sklepie w kraju ludzie robią normalne zakupy a w Biedrze jakby jutro ruscy mieli wbić z krymu? xD Come on 20 kilo cukru kurwa? XD", "ty", "26/08/2018 22:41:00", tags04, 89));
        ...
        list.add(new Note("kokaina","oe", "26/08/2018 22:41:00", tags03,123));
        ...
        list.add(new Note("Jak mnie ten kraj wkurwia XD","oe", "26/08/2018 22:41:00", tags03, 120));
        list.add(new Note("Dlaczego zawsze na ulicy jakaś grupka patusów musi puszczać te upośledzone rapsy na głośnikach?","oe", "26/08/2018 22:41:00", tags02, 1111));
        list.add(new Note("Niedługo podniosę deskę w kiblu i zobacze reklame MJUZIKLI","oe", "26/08/2018 22:41:00", tags01, 555));
        list.add(new Note("Mieszkanie na studiach ssie XD Mogłam się siąść xD “Będe sam gotowała” ehe ","oe", "26/08/2018 22:41:00", tags04, 0));
        list.add(new Note("Kiedy kupujesz kebsa za 17 zł z 20 jakie masz i po dwóch gryzach znajdujesz w nim robaka","oe", "26/08/2018 22:41:00", tags02, 12));
        list.add(new Note("Co wróce do domu to starzy robią 16 okrążenie po ranczu. Ileż kurwa można to puszcać. Na pamięć mam już kwestie solejuka hadziuka i innych pierdół","oe", "26/08/2018 22:41:00", tags01, 94));
        list.add(new Note("Dlaczego moja loszka cały czas truje mi dupe? Like czasami zdaje mi sie, że odbija karte na zakładzie XD","oe", "26/08/2018 22:41:00", tags03, 55));
        list.add(new Note("Pozdrowienia dla ludzi dających coś do relacji na fb :))) Żal","oe", "26/08/2018 22:41:00", tags04, 8));
        list.add(new Note("Grill rodzinny a pół rodziny to janusze. KURŁA XD bez jaj ostatnie 40 minut to rozmowa jak w oplu szwagra naprawić rozrząd czy jak to gówno sie tam nazywa XD","oe", "26/08/2018 22:41:00", tags01, 2));
        list.add(new Note("Dobra odkąd wprowadzili 500+ w moim mieście patola wzrosła tak ze dwa razy XD Tyle karyn z wózkami co widze codziennie wracając ze szkoły to dawniej przez cały tydzień nie widziałem. Jak to wycofają to chyba patusy zaczną palić sklepy XD","oe", "26/08/2018 22:41:00", tags04, 33));
        list.add(new Note("Ludzie są zjebani. Powiedziałem mojemu dalszemu znajomemu który ma kapele metalową, że moge im nakrecic teledysk (troszke sie bawie w nagrywanie i montowanie i lubie to) do ich pierwszej piosenki jeśli chcą za darmo. Wszyscy szczęśliwi. Spóźniłem sie godzinę z winy korków na nagrywanie i wszyscy mnie opierdolili z nich, że jestem nie słowny. Niby im to nagrałem ale teraz mam takie, że żałuje ze nie powiedzialem im zeby spierdalali","oe", "26/08/2018 22:41:00", tags03, 55));
        ...
        list.add(new Note("Wkurwia mnie to, że auto rodziców stoi 6 dni w tygodniu w domu ale gdy chce je pożyczyc zeby przejechać sie 10km dalej to nie bo będzie potrzebne. #kurwamadź","oe", "26/08/2018 22:41:00", tags01, 18));
        list.add(new Note("Drugi dzień po kupnie Iphona X i pomyślałem że kupie sobie twardą szybke bo bym umarł gdybym odrazu to rozwalił. Wbiłem do serwisu i w momencie przekazywania typowi telefonu wypadł mi z ręki i jebnął o ziemie. Podnosze i pajęczyna . Ja zrobilem sie blady a typo złapał sie za łeb. To mogło być bardziej pechowe?","oe", "26/08/2018 22:41:00", tags03, 3));
        list.add(new Note("Mam dość mojego chłopaka","oe", "26/08/2018 22:41:00", tags01, 99));
        list.add(new Note("Czwartą noc z rzędu tuż przed zasnięciem swędzi mnie najmniejszy palec u nogi i wybudza. Ty mały skurwysynie xD","oe", "26/08/2018 22:41:00", tags04, 100));
